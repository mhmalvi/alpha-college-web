    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 page-content">
          <p><span>//</span> CPC10111</p>
          <h1>Certificate I in Construction</h1>
          <div class="page_nav">
      ...
      <div class="row">
        <div style="display: flex; justify-content: center;">
          <div class="col-sm-8 course_detail wow fadeIn" data-wow-delay="400ms">
            <img src="{{asset('assets/images/cpc10111-certificate-i-in-construction.jpg')}}" alt="Course" class=" border_radius img-responsive bottom15">
                ...
                <div class="col-md-4">
                  <table>
                    <tr>
                      ...
                      <td>
                        <p><a href="{{route('qualificationFile', 'CPC10111_R3')}}">Qualification (click to download)</a></p>
                      </td>
                    </tr>
                  </table>
                </div>
